...
public abstract class SaveBulletinActivity extends BaseActivity implements
    ...
    @BindView(R.id.edit_text_bulletin_theme) protected EditText mSubject;
    @BindView(R.id.edit_text_bulletin_text) protected EditText mText;
    @BindView(R.id.toolbar) protected Toolbar mToolbar;
    @BindView(R.id.text_view_start_period) protected EditText mStartDate;
    @BindView(R.id.text_view_end_period) protected EditText mEndDate;
    @BindView(R.id.text_view_creation_date_value) protected TextView mCreateDate;
    @BindView(R.id.spinner_profile) protected Spinner mSpinnerProfile;
    @BindView(R.id.spinner_group) protected Spinner mSpinnerGroup;
    @BindView(R.id.spinner_subdivision) protected Spinner mSpinnerSubdivision;
    @BindView(R.id.layout_profile) protected RelativeLayout mLayoutProfile;
    @BindView(R.id.layout_group) protected RelativeLayout mLayoutGroup;
    @BindView(R.id.rb_all) protected RadioButton mRbAll;
    @BindView(R.id.rb_profile) protected RadioButton mRbProfile;
    @BindView(R.id.rb_group) protected RadioButton mRbGroup;
    @BindView(R.id.btn_more_information) protected ImageButton mMoreInfoBtn;
    @Inject
